...
class SoftmaxModel(Model):
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None):
        ...
        """
        ### YOUR CODE HERE
        feed_dict = {self.input_placeholder:inputs_batch,self.labels_palceholder:labels_batch}
        ### END YOUR CODE
        return feed_dict
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss = cross_entropy_loss(self.labels_palceholder, pred)
        ### END YOUR CODE
        return loss
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        train_op = tf.train.GradientDescentOptimizer(Config.lr).minimize(loss=loss)
        ### END YOUR CODE
        return train_op
